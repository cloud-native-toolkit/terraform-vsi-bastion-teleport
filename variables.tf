...
# App ID Variables
##############################################################################
variable "create_new_appid" {
  description = "Set to true if user needs to create a APP ID instance otherwise set to false to use existing appid"
  type        = bool

}

variable "appid_resource_key_name" {
  description = "Name of the resource key to be created in new or existing APP ID instances"
  type        = string

}

# Existing APP ID Instance Variable
variable "appid_name" {
  description = "Name of existing APP ID instance which you would like to use"
  type        = string
