...
resource "ibm_resource_instance" "new_appid" {
  count    = var.create_new_appid == true ? 1 : 0
...
resource "ibm_appid_redirect_urls" "urls" {
  ...
  tenant_id = var.create_new_appid == true ? resource.ibm_resource_instance.new_appid[0].guid : data.ibm_resource_instance.appid[0].guid
  urls = [
...
data "ibm_resource_instance" "appid" {
  count             = var.create_new_appid == false ? 1 : 0
  name              = var.appid_name
